...
class BottomSheetIndicator {
    ...
    static get encapsulation() { return "shadow"; }
    static get style() { return ":host{display:block}div{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;margin:0 auto var(--sheet-content-padding-bottom) auto;-webkit-transform:rotate(calc(var(--progress) * -180deg));transform:rotate(calc(var(--progress) * -180deg));color:var(--sheet-indicator-color)}div,svg{width:var(--sheet-indicator-size);height:var(--sheet-indicator-size)}svg{fill:currentColor}"; }
}
...
class BottomSheetScreen {
    ...
    static get style() { return ":host{display:block;position:absolute;top:0;right:0;bottom:0;left:0;z-index:calc(var(--sheet-z-index, 9) - 1);background-color:var(--sheet-screen-background,rgba(0,0,0,.4))}"; }
}
